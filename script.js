...
const openModal=(modal,focusTarget)=>{modal.hidden=false;document.body.classList.add('jgw-modal-open');modal.dataset.returnFocus='true';requestAnimationFrame(()=>focusTarget?.focus())};
